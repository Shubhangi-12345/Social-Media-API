...
from .views import RegistrationView, LoginView, LogoutView, ChangePasswordView, EmployeeList, ResetPasswordView, ProfileViewSet
...
urlpatterns = [
    ...
    path('api/profile', ProfileViewSet.as_view(), name='profile-change'),
]
